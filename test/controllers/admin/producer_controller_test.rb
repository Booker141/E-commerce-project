...
class Admin::ProducerControllerTest < ActionDispatch::IntegrationTest
 fixtures :producers
  ...
  test "create" do
    ...
    post '/admin/producer/create', :params => { :producer => { :name => 'The Monopoly Publishing Company' }}
  ...
  test "destroy" do
    assert_difference(Producer, :count, -1) do
      ...
      assert_equal flash[:notice], 'Destilería Apress eliminada correctamente.'
      assert_response :redirect
      assert_redirected_to :action => 'index'
      get '/admin/producer/index'
      assert_response :success
      assert_select 'div#notice', 'Destilería Apress eliminada correctamente.'
    end
  end
