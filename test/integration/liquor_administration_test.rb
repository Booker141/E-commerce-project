...
class LiquorAdministrationTest < ActionDispatch::IntegrationTest
   test "liquor_administration" do
    producer = Producer.create(:name => 'Liquors of Ruby')
  ...
  module LiquorTestDSL
    ...
    def add_liquor(parameters)
      ...
      post '/admin/liquor/create', :params => parameters
    ...
    def edit_liquor(liquor, parameters)
      ...
      post "/admin/liquor/update?id=#{liquor.id}", :params => parameters
      assert_response :redirect
      follow_redirect!
      assert_response :success
